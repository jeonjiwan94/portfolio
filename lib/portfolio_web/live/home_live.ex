        ...
        <!--  원래: class="mx-auto mt-16 max-w-6xl px-4 lg:px-0"  -->
          ...
          <div class="mt-8 columns-1 sm:columns-2 lg:columns-3 gap-8">
            ...
            >
              <blockquote class="text-gray-900 dark:text-gray-100">
                <p>
                  "지완님은 단순히 주어진 업무를 수행하는 팀원을 넘어, 조직과 팀의 발전을 위해 무엇이
                  필요한지를 스스로 고민하고 먼저 해결책을 제시할 수 있는 관리자적 역량을 갖춘 동료였습니다.
                </p>
                <p class="mt-4">
                  특히 팀장으로서 고민하고 있던 문제를 한발 앞서 파악하고, 지시를 기다리기보다 스스로
                  해결방안을 찾아 실행하는 모습이 인상적이었습니다. 그래서 저는 지완님을 '팀원'이라는
                  표현보다 함께 고민하고 함께 책임지는 '동료'라는 표현이 더 잘 어울리는 사람이라고
                  생각합니다.
                </p>
                <p class="mt-4">
                  또한 조직을 운영하다 보면 때로는 누군가의 희생과 헌신이 필요한 어렵고 까다로운 일이
                  생깁니다. 지완님은 그런 상황에서도 '이것이 내가 해야 할 역할이라면 한다'는 자세로
                  누구보다 먼저 나서서 책임을 다해주었습니다. 단순한 성실함을 넘어 조직을 위해 기꺼이
                  책임을 짊어질 수 있는 사람이라는 의미입니다.
                </p>
                <p class="mt-4">
                  제가 생각하는 좋은 관리자의 핵심 자질은 두 가지입니다. 하나는 자기희생을 바탕으로 한
                  솔선수범, 다른 하나는 위기를 미리 예측하고 예방하며, 위기가 발생했을 때 피해를
                  최소화하는 위기관리 능력입니다.
                </p>
                <p class="mt-4">
                  그런 관점에서 보면 지완님은 이미 상당 부분 완성된 관리자에 가까운 역량을 갖춘 인재라고
                  생각합니다. 직책이나 권한이 주어져야만 리더십을 발휘하는 사람이 아니라, 직책이 없어도
                  스스로 판단하고 책임지며 주변을 움직일 수 있는 사람이기 때문입니다.
                </p>
                <p class="mt-4">
                  저라면 향후 지완님과 다시 함께 일할 기회가 있다면 가장 먼저 손을 내밀고 싶은 사람 중
                  한 명입니다. 특히 제가 언젠가 사업을 하게 된다면, 가장 먼저 함께하고 싶은 사람으로
                  지완님을 꼽을 것입니다.
                </p>
                <p class="mt-4">
                  그만큼 신뢰할 수 있고, 책임감이 강하며, 조직의 성장을 자신의 일처럼 고민할 수 있는
                  사람이라고 평가합니다."
                </p>
              </blockquote>
              <figcaption class="mt-6 flex items-center gap-x-4">
                <div>
                  <div class="font-semibold text-gray-900 dark:text-white">국X현</div>
                  <div class="text-gray-600 dark:text-gray-400">(현)빅웨이브로보틱스 서비스로봇 팀장</div>
                </div>
              </figcaption>
            </figure>
